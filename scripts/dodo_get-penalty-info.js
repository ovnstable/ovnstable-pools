...
let dodoAddress = "0x813fddeccd0401c4fa73b092b074802440544e52";
...
async function main() {
    ...
    let dodo = await ethers.getContractAt(dodoAbi, dodoAddress, wallet);

    let _BASE_BALANCE_ = await dodo._BASE_BALANCE_();
    let _K_ = await dodo._K_();
    let _QUOTE_BALANCE_ = await dodo._QUOTE_BALANCE_();
    let _R_STATUS_ = await dodo._R_STATUS_();
    let _TARGET_QUOTE_TOKEN_AMOUNT_ = await dodo._TARGET_QUOTE_TOKEN_AMOUNT_();

    console.log(`_BASE_BALANCE_: ${_BASE_BALANCE_}`);
    console.log(`_K_: ${_K_}`);
    console.log(`_QUOTE_BALANCE_: ${_QUOTE_BALANCE_}`);
    console.log(`_R_STATUS_: ${_R_STATUS_}`);
    console.log(`_TARGET_QUOTE_TOKEN_AMOUNT_: ${_TARGET_QUOTE_TOKEN_AMOUNT_}`);

    let penalty;
    penalty = await dodo.getWithdrawBasePenalty("100000");
    console.log(`penalty: ${penalty}`)
    penalty = await dodo.getWithdrawBasePenalty("1000000");
    console.log(`penalty: ${penalty}`)
    penalty = await dodo.getWithdrawBasePenalty("10000000");
    console.log(`penalty: ${penalty}`)
    penalty = await dodo.getWithdrawBasePenalty("100000000");
    console.log(`penalty: ${penalty}`)
    penalty = await dodo.getWithdrawBasePenalty("1000000000");
    console.log(`penalty: ${penalty}`)
